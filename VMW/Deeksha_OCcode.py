...
searchurl = "https://myvmware.workspaceair.com/SAAS/jersey/manager/api/catalogitems/search?startIndex=0&pageSize=15000"
...
"""for nm in mainlist:
    ...
    requrl = "https://ws-cet-vidm1.vmware.com/SAAS/jersey/manager/api/catalogitems/" + uuid
    print(requrl)
    headers3 = {'Accept' : 'application/vnd.vmware.horizon.manager.catalog.saml20+json', 'Authorization' : 'Bearer ' + accesstoken}
    neworgurl = "https://wdc-vcd01.oc.vmware.com/tenant/"+orgname+"/"
    print(neworgurl)
